  ...
  return (
    <footer className="bg-gradient-to-br from-[#0A1A2F] via-[#0F2B52] to-[#0A1A2F] text-white relative overflow-hidden">
      ...
      <div className="relative">
        {/* Newsletter Section */}
        <div className="border-b border-[#00D4FF]/20 w-full">
          <div className="max-w-[1400px] mx-auto px-[4%] py-8 sm:py-12">
            <div className="max-w-4xl mx-auto text-center">
              <h3 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 text-[#E0F7FF]">Đăng ký nhận tin tức</h3>
              <p className="text-[#B0D0E8] mb-6 sm:mb-8 text-base sm:text-lg">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 max-w-md mx-auto">
                <input
                  ...
                  className="flex-1 px-4 py-2.5 sm:py-3 rounded-full bg-[#0F2B52]/50 border border-[#00D4FF]/50 text-white placeholder-[#B0D0E8] focus:outline-none focus:ring-2 focus:ring-[#00D4FF] focus:border-transparent backdrop-blur-sm text-sm sm:text-base"
                />
                <button className="bg-gradient-to-r from-[#00D4FF] to-[#00B8E6] px-6 sm:px-8 py-2.5 sm:py-3 rounded-full font-semibold hover:shadow-lg transition-all duration-300 hover:scale-105 text-[#0A1A2F] text-sm sm:text-base">
                  Đăng ký
                </button>
              </div>
            </div>
        ...
        {/* Main Footer Content */}
        <div className="max-w-[1400px] mx-auto px-[4%] py-10 sm:py-12 md:py-16">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {/* Company Info */}
            <div className="lg:col-span-1">
              <Link href="/" className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-[#00D4FF] to-[#00B8E6] rounded-xl flex items-center justify-center shadow-lg flex-shrink-0">
                  <span className="text-xl sm:text-2xl">🛒</span>
                </div>
                <div>
                  <div className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-[#00D4FF] to-[#00B8E6] bg-clip-text text-transparent">
                    TechZone
                  </div>
                  <div className="text-xs text-[#B0D0E8]">Future of Shopping</div>
                </div>
              </Link>
              <p className="text-[#B0D0E8] leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">
              ...
              <div className="flex gap-3 sm:gap-4">
                <a href="#" className="w-9 h-9 sm:w-10 sm:h-10 bg-[#0F2B52]/50 rounded-full flex items-center justify-center hover:bg-[#00D4FF] transition-colors duration-300 backdrop-blur-sm flex-shrink-0">
                  <span className="text-base sm:text-lg">📘</span>
                </a>
                <a href="#" className="w-9 h-9 sm:w-10 sm:h-10 bg-[#0F2B52]/50 rounded-full flex items-center justify-center hover:bg-[#FF6B6B] transition-colors duration-300 backdrop-blur-sm flex-shrink-0">
                  <span className="text-base sm:text-lg">📸</span>
                </a>
                <a href="#" className="w-9 h-9 sm:w-10 sm:h-10 bg-[#0F2B52]/50 rounded-full flex items-center justify-center hover:bg-[#00B8E6] transition-colors duration-300 backdrop-blur-sm flex-shrink-0">
                  <span className="text-base sm:text-lg">🐦</span>
                </a>
                <a href="#" className="w-9 h-9 sm:w-10 sm:h-10 bg-[#0F2B52]/50 rounded-full flex items-center justify-center hover:bg-[#FF6B6B] transition-colors duration-300 backdrop-blur-sm flex-shrink-0">
                  <span className="text-base sm:text-lg">📺</span>
            ...
            {/* Quick Links */}
            <div>
              <h4 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6 text-[#00D4FF]">Danh mục sản phẩm</h4>
              <ul className="space-y-2 sm:space-y-3">
                <li>
                  <Link href="/danh-muc/dien-thoai" className="text-[#B0D0E8] hover:text-[#E0F7FF] transition-colors duration-200 flex items-center gap-2 text-sm sm:text-base">
                    <span>📱</span>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-[#00D4FF]/20 w-full">
          <div className="max-w-[1400px] mx-auto px-[4%] py-4 sm:py-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-[#B0D0E8] text-xs sm:text-sm text-center md:text-left">
